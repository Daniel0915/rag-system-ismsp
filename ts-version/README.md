# RAG 시스템 (TypeScript + Gemini/Ollama 버전)

원본 저장소의 Python/LangChain/OpenAI/Streamlit 커리큘럼(00~07)을 **TypeScript + Express**로 포팅한 버전입니다. LLM은 **Google Gemini(클라우드)** 또는 **Ollama(로컬, 예: Qwen)** 중 하나를 환경변수 하나로 선택할 수 있습니다. Python 원본은 그대로 저장소 루트에 남아 있으며, 이 폴더는 완전히 독립적인 프로젝트입니다.
